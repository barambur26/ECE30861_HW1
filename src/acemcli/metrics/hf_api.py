...
from acmecli.models import MetricResult, Category, SizeScore
...
meta = self.api.model_info(f"{namespace}/{repo}") if is_model else self.api.dataset_info(f"{namespace}/{repo}")
...
size_score={"raspberry_pi":0.0,"jetson_nano":0.0,"desktop_pc":0.0,"aws_server":0.0}, size_score_latency=0,
